...
pub struct UpdateHistoryTransaction {
...
impl UpdateHistoryTransaction {
    pub fn new(update_id: String, migration_id: i64, workflow_id: String, record_time: String, synchronizer_id: String, effective_at: String, offset: String, root_event_ids: Vec<String>, events_by_id: std::collections::HashMap<String, models::TreeEvent>) -> UpdateHistoryTransaction {
