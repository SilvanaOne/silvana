...
------------ | ------------- | ------------- | -------------
**activity_type** | **String** | Describes the type of activity that occurred. Determines if the data for the activity should be read from the `transfer`, `mint`, or `tap` property.  | 
