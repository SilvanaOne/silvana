...
pub struct CreatedEvent {
    ...
    #[serde(rename = "representativePackageId")]
...
impl CreatedEvent {
    ...
    pub fn new(offset: i64, node_id: i32, contract_id: String, template_id: String, created_event_blob: String, created_at: String, package_name: String, representative_package_id: String, acs_delta: bool) -> CreatedEvent {
        CreatedEvent {
            offset,
            node_id,
            contract_id,
