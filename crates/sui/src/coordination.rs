...
impl SuiCoordination {
    ...
    async fn extract_job_sequence_from_tx(&self, tx_hash: &str) -> Result<u64, SilvanaSuiInterfaceError> {
        ...
        let events_json = crate::transactions::fetch_transaction_events_as_json(tx_hash).await
    ...
    fn convert_multicall_operations(&self, ops: MulticallOperations) -> crate::types::MulticallOperations {
        crate::types::MulticallOperations {
...
impl Coordination for SuiCoordination {
    ...
    async fn multicall_job_operations(
        ...
        let internal_ops: Vec<crate::types::MulticallOperations> = operations
            .into_iter()
