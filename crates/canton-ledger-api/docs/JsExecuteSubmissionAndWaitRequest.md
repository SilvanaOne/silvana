...
------------ | ------------- | ------------- | -------------
**prepared_transaction** | Option<**String**> | the prepared transaction Typically this is the value of the `prepared_transaction` field in `PrepareSubmissionResponse` obtained from calling `prepareSubmission`. Required | [optional]
...
**user_id** | **String** | See [PrepareSubmissionRequest.user_id] Optional | 
**hashing_scheme_version** | **String** | The hashing scheme version used when building the hash Required | 
