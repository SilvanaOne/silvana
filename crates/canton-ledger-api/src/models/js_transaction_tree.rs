...
impl JsTransactionTree {
    ...
    pub fn new(update_id: String, command_id: String, workflow_id: String, offset: i64, events_by_id: std::collections::HashMap<String, models::TreeEvent>, synchronizer_id: String, record_time: String) -> JsTransactionTree {
        JsTransactionTree {
            update_id,
            command_id,
            workflow_id,
