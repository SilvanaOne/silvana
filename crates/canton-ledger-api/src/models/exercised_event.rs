...
impl ExercisedEvent {
    ...
    pub fn new(offset: i64, node_id: i32, contract_id: String, template_id: String, choice: String, choice_argument: Option<serde_json::Value>, consuming: bool, last_descendant_node_id: i32, exercise_result: Option<serde_json::Value>, package_name: String, acs_delta: bool) -> ExercisedEvent {
        ExercisedEvent {
            offset,
            node_id,
            contract_id,
