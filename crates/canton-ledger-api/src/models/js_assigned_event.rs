...
impl JsAssignedEvent {
    ...
    pub fn new(source: String, target: String, reassignment_id: String, submitter: String, reassignment_counter: i64, created_event: models::CreatedEvent) -> JsAssignedEvent {
        JsAssignedEvent {
            source,
            target,
            reassignment_id,
