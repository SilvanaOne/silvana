...
pub struct GetPreferredPackagesResponse {
    ...
    #[serde(rename = "packageReferences", skip_serializing_if = "Option::is_none")]
    pub package_references: Option<Vec<models::PackageReference>>,
...
impl GetPreferredPackagesResponse {
    pub fn new(synchronizer_id: String) -> GetPreferredPackagesResponse {
