...
impl UnassignedEvent {
    ...
    pub fn new(reassignment_id: String, contract_id: String, source: String, target: String, submitter: String, reassignment_counter: i64, package_name: String, offset: i64, node_id: i32) -> UnassignedEvent {
        UnassignedEvent {
            reassignment_id,
            contract_id,
            template_id: None,
