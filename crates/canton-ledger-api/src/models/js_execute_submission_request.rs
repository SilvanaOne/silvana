...
impl JsExecuteSubmissionRequest {
    pub fn new(deduplication_period: models::DeduplicationPeriod2, submission_id: String, user_id: String, hashing_scheme_version: String) -> JsExecuteSubmissionRequest {
