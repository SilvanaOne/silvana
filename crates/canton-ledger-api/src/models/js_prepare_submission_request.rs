...
pub struct JsPrepareSubmissionRequest {
    ...
    #[serde(rename = "prefetchContractKeys", skip_serializing_if = "Option::is_none")]
    pub prefetch_contract_keys: Option<Vec<models::PrefetchContractKey>>,
    ...
    #[serde(rename = "maxRecordTime", skip_serializing_if = "Option::is_none")]
    pub max_record_time: Option<String>,
    #[serde(rename = "estimateTrafficCost", skip_serializing_if = "Option::is_none")]
    pub estimate_traffic_cost: Option<Box<models::CostEstimationHints>>,
}
