...
impl EventDatabase {
    ...
    /// Query settlement proofs by app_instance_id and block_number
    /// Uses the composite index: idx_app_instance_id_block_number_settlement_proof
    pub async fn get_settlement_proofs(
        ...
        debug!(
            "Querying settlement proofs: app_instance_id={}, block_number={}",
            app_instance_id, block_number
        );
        ...
        // idx_app_instance_id_block_number_settlement_proof
        ...
        debug!(
            "Found {} settlement proofs for app_instance_id={}, block_number={}",
            results.len(),
            normalized_app_id,
            block_number
        );
